...
@router.post("/save")
@version(1)
async def save_config(file_path: Optional[str] = None) -> Dict[str, Any]:
...
async def get_hot_reload_status() -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to get hot reload status: {e}"
        )
...
async def enable_hot_reload() -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to enable hot reload: {e}"
        )
...
async def disable_hot_reload() -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to disable hot reload: {e}"
        )
...
async def get_config_schema() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "schema": schema,
            "description": "Configuration schema for rez-proxy"
        }
    except Exception as e:
        raise HTTPException(
            status_code=500,
            detail=f"Failed to get configuration schema: {e}"
        )
