    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            if allow_override:
                ...
                if os.environ.get("REZ_PROXY_FORCE_WEB_COMPATIBILITY", "").lower() in (
                    "true",
                    "1",
                    "yes",
                ):
            ...
            if level == CompatibilityLevel.INCOMPATIBLE:
                ...
                if hasattr(response, "headers"):
                    ...
                    response.headers["X-Web-Compatibility-Reason"] = (
                        reason or "Limited web compatibility"
                    )
                return response
...
def get_api_compatibility_info(func: Callable) -> dict[str, Any] | None:
...
async def web_compatibility_exception_handler(
    request: Request, exc: WebCompatibilityError
) -> JSONResponse:
