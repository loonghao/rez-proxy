...
class WebEnvironmentDetector:
    ...
    def __init__(self):
        ...
        self._detection_cache: Optional[bool] = None
        self._forced_mode: Optional[ServiceMode] = None
        ...
        return {
            ...
            "relevant_env_vars": {
                ...
                if any(indicator in key.upper() for indicator in [
                    "WEB", "HTTP", "SERVER", "DOCKER", "KUBERNETES", "VERCEL", 
                    "NETLIFY", "HEROKU", "AWS", "GOOGLE", "AZURE", "REZ_PROXY"
                ])
            }
        }
...
_web_detector: Optional[WebEnvironmentDetector] = None
